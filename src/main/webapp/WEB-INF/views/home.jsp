...
<div class="splash"> <div class="color-line"></div><div class="splash-title"><h1>íë¬¼íë¡</h1><p>Special íë¬¼ ì£¼ì  ìì¤í</p><img src="../images/loading-bars.svg" width="64" height="64" /> </div> </div>
<!--[if lt IE 7]>
<p class="alert alert-danger">You are using an <strong>outdated</strong> browser. Please <a href="http://browsehappy.com/">upgrade your browser</a> to improve your experience.</p>
<![endif]-->
    <!-- Page view wrapper -->
    <div ui-view autoscroll="true"></div>
<script data-main="/js/app-init.js" src="bower_components/requirejs/require.js"></script>
</body>
</html>
